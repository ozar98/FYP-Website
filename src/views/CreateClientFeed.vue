  ...
  <div>
	...
	<div class="container px-xl-0">
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h2 class="mb-55 small text-center" data-aos-duration="600" data-aos="fade-down" data-aos-delay="0">New post for clients</h2>
						...
						<div class="ml-30 inner form-group w-600">
							<label for="exampleInputEmail1">Car Pricing</label>
								<div class="row ">
									...
									<div class="col">
										<button type="submit" class=" btn-outline-warning mt-4  ">TJK</button>
									</div>
								</div>
							<div class="inner color-dark mt-2 text-adaptive">
								Number of seats              
							</div>
							<div class=" inner">
								<div class="w-370 block">
							...
							<div class=" inner">
								<div class="w-370 block">
									<div class="row ">
										<div class="col">
											<label class="mt-25 text-dark"><b>No Departure Date</b></label>
										</div>
										<div class="col">
  ...
  components: {
	...
	methods: {
		async createPost(){
			...
			await axios.post("https://fyp-new-backend.herokuapp.com/api/v1/client/", requestShape, {
				headers: {
